...
for channel in range(2):
    try:
        f = open("temperature_feedback_risetime_data_{}.pkl".format(channel), "rb")
    except Exception as e:
        print("Skipping channel {}".format(channel))
        continue
    ...
    plt.savefig("temperature_feedback_risetime_data_{}.pdf".format(channel))
